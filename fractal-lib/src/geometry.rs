...
mod test {
    ...
    fn test_view_area_transformer_map_pixel1() {
        ...
        assert_approx_eq!(
            vat.map_point_to_pixel(Point { x: 1.0, y: 1.0 })[0],
            700.0,
            0.000000000001
        );
        assert_approx_eq!(
            vat.map_point_to_pixel(Point { x: 1.0, y: 1.0 })[1],
            0.0,
            0.000000000001
        );
    ...
    fn test_view_area_transformer_map_pixel3() {
        ...
        assert_approx_eq!(
            vat.map_point_to_pixel(Point { x: 3.0, y: 3.0 })[0],
            0.0,
            0.000000000001
        );
        assert_approx_eq!(
            vat.map_point_to_pixel(Point { x: 3.0, y: 3.0 })[1],
            3.5,
            0.000000000001
        );

        assert_approx_eq!(
            vat.map_point_to_pixel(Point { x: 12.0, y: 12.0 })[0],
            3.0,
            0.000000000001
        );
        assert_approx_eq!(
            vat.map_point_to_pixel(Point { x: 12.0, y: 12.0 })[1],
            0.5,
            0.000000000001
        );
    }
